  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Admin NextTech</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('departemen.index')}}">
          <i class="bi bi-layout-text-window-reverse"></i><span>Departeman</span></i>
        </a>
      </li><!-- End Tables Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('pegawai.index')}}">
          <i class="bi bi-layout-text-window-reverse"></i><span>Pegawai</span></i>
        </a>
      </li><!-- End Tables Nav -->
    </ul>
